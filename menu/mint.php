...
// 350 Gram
$getjumlah = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '24'");
...
// 500 Gram
$getjumlah1 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '25'");
  ...
  <body>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item  active" href="#">Madu Mint</a>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
          <h1 class="text-center text-warning">Madu Mint</h1>
          <h5 class="border-bottom">Java Hills Madu rasa <i>Mint</i> merupakan Extrak Mint, Jahe, Minyak Zaitun, Habbtusauda Propolis, Pegagan, dan Temulawak.</h5>
          <div class="card-deck">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title text-dark border-bottom text-center">Manfaat Madu Mint</h5>
                  <div class="card-group">
                    <div class="card">
                      <div class="card-body">
                        <?php
                          $getmint = mysqli_query ($koneksi,"SELECT * FROM mint ");
                          while ($data=mysqli_fetch_array($getmint)) {
                          $idmint = $data['id_mint'];
