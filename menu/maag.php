...
// 350 Gram
$getjumlah = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '22'");
...
// 500 Gram
$getjumlah1 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '23'");
  ...
  <body>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item  active" href="#">Madu Maag</a>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
          <h1 class="text-center text-warning">Madu Maag</h1>
          <h5 class="border-bottom">Java Hills Madu rasa <i>Maag</i> merupakan Komposisi: Madu, Sambiloto, Kunyit, Habbatussauda, Temulawak, Jahe, Olive oil.</h5>
          <div class="card-deck">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title text-dark border-bottom text-center">Manfaat Madu Maag</h5>
                  <div class="card-group">
                    <div class="card">
                      <div class="card-body">
                        <?php
                          $getmaag = mysqli_query ($koneksi,"SELECT * FROM maag ");
                          while ($data=mysqli_fetch_array($getmaag)) {
                          $idmaag = $data['id_maag'];
