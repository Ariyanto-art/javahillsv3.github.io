...
// 350 Gram
$getjumlah = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '29'");
...
// 500 Gram
$getjumlah1 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '30'");
...
// 690 Gram
$getjumlah2 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '31'");
  ...
  <body>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item  active" href="#">Randu Blossom</a>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
          <h1 class="text-center text-warning">Madu Randu Blossom</h1>
          <h5 class="border-bottom">Java Hills Madu rasa <i>Randu Blossom</i> merupakan Madu mentah premium yang berasal dari nektar bunga pohon randu yang bunganya sedang bermekaran. Komposisi: 100% madu randu murni.</h5>
          <div class="card-deck">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title text-dark border-bottom text-center">Manfaat Madu Randu Blossom</h5>
                  <div class="card-group">
                    <div class="card">
                      <div class="card-body">
                        <?php
                          $getrandu = mysqli_query ($koneksi,"SELECT * FROM randu ");
                          while ($data=mysqli_fetch_array($getrandu)) {
                          $idrandu = $data['id_randu'];
