...
// 500 Gram
$getjumlah = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '19'");
...
// 650 Gram
$getjumlah1 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '20'");
...
// 1000 Gram
$getjumlah2 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '21'");
  ...
  <body>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item  active" href="#">Kalimantan Super</a>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
          <h1 class="text-center text-warning">Madu Kalimantan Super</h1>
          <h5 class="border-bottom"></h5>
          <div class="card-deck">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title text-dark border-bottom text-center">Manfaat Madu Kalimantan Super</h5>
                  <div class="card-group">
                    <div class="card">
                      <div class="card-body">
                        <?php
                          $getkalimantan = mysqli_query ($koneksi,"SELECT * FROM kalimantan ");
                          while ($data=mysqli_fetch_array($getkalimantan)) {
    ...
    <script src="../assets/js/vendor/poppe../r.min.js"></script>
