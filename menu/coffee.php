...
// 350 Gram
$getjumlah = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '11'");
...
// 500 Gram
$getjumlah1 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '12'");
...
// 650 Gram
$getjumlah2 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '13'");
...
// 1000 Gram
$getjumlah3 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '14'");
...
// 1400 Gram
$getjumlah4 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '15'");
  ...
  <body>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item  active" href="#">Coffee Blossom</a>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
          <h1 class="text-center text-warning">Madu Coffee Blossom</h1>
          <h5 class="border-bottom">Java Hills Madu rasa <i>Coffee Blossom</i> merupakan sebuah madu yang dihasilkan dari hewan kecil bernama lebah yang bertugas mengambil nektar dari pohon kopi.</h5>
          <div class="card-deck">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title text-dark border-bottom text-center">Manfaat Madu Coffee Blossom</h5>
                  <div class="card-group">
                    <div class="card">
                      <div class="card-body">
                        <?php
                          $getcoffee = mysqli_query ($koneksi,"SELECT * FROM coffee ");
                          while ($data=mysqli_fetch_array($getcoffee)) {
                          $idcoffee = $data['id_coffee'];
