...
// 350 Gram
$getjumlah = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '9'");
...
// 500 Gram
$getjumlah1 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '10'");
  ...
  <body>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item  active" href="#">Acacia Blossom</a>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
          <h1 class="text-center text-warning">Madu Acacia Blossom</h1>
          <h5 class="border-bottom">Java Hills Madu rasa <i>Acacia Blossom</i> dikenal denga madu hitam pahit adalah madu mentah premium yang berasal dari nektar bunga pohon acacia.</h5>
          <div class="card-deck">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title text-dark border-bottom text-center">Manfaat Madu Acacia Blossom</h5>
                  <div class="card-group">
                    <div class="card">
                      <div class="card-body">
                        <p class="card-text text-dark"><img src="../assets/img/dot.svg" width="20px;">Meningkatkan imunitas/daya tahan tubuh</p>
                        <p class="card-text text-dark"><img src="../assets/img/dot.svg" width="20px;">Batuk/radang tenggorokan</p>
                        <p class="card-text text-dark"><img src="../assets/img/dot.svg" width="20px;">Prebiotik alami</p>
                        <p class="card-text text-dark"><img src="../assets/img/dot.svg" width="20px;">Membersihkan Pencernaan</p>
                        <p class="card-text text-dark"><img src="../assets/img/dot.svg" width="20px;">Menurunkan berat badan dan kolestrol</p>
                      </div>
                    </div>
                    <div class="card">
                      <div class="card-body">
                        <p class="card-text text-dark"><img src="../assets/img/dot.svg" width="20px;">Membuat tidur nyenyak</p>
                        <p class="card-text text-dark"><img src="../assets/img/dot.svg" width="20px;">Mencegah diabetes</p>
                        <p class="card-text text-dark"><img src="../assets/img/dot.svg" width="20px;">Mencegah kanker</p>
                        <p class="card-text text-dark"><img src="../assets/img/dot.svg" width="20px;">Menyehatkan Jantung</p>
                        <p class="card-text text-dark"><img src="../assets/img/dot.svg" width="20px;">Menyembuhkan Luka</p>
                      </div>
                    </div>
                  </div>
              </div><!-- card-body -->
