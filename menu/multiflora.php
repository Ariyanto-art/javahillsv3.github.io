...
// 350 Gram
$getjumlah = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '4'");
...
// 500 Gram
$getjumlah1 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '5'");
...
// 650 Gram
$getjumlah2 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '6'");
...
// 1000 Gram
$getjumlah3 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '7'");
$jumlah3 = mysqli_fetch_array($getjumlah3);

$stock3 = $jumlah3['qty'];
$ukuran3 = $jumlah3['ukuran'];
$namabarang3 = $jumlah3['namabarang'];
$harga3 = $jumlah3['harga'];

// 1400 Gram
$getjumlah4 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '8'");
$jumlah4 = mysqli_fetch_array($getjumlah4);

$stock4 = $jumlah4['qty'];
$ukuran4 = $jumlah4['ukuran'];
$namabarang4 = $jumlah4['namabarang'];
$harga4 = $jumlah4['harga'];
  ...
  <body>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              <a class="dropdown-item active" href="#">Multiflora</a>
              ...
              <a class="dropdown-item" href="rambutan.php">Rambutan Blossom</a>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
          <h1 class="text-center text-warning">Madu Multiflora</h1>
          <h5 class="border-bottom">Java Hills Madu rasa <i>Multifora</i> adalah madu yang rasanya manis asem seger yang dihasilkan dari nektar berbagai jenis pohon dengan jenis lebah melifera atsu biasa di kenal dengan jenis lebah unggulan.</h5>
          <div class="card-deck">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title text-dark border-bottom text-center">Manfaat Madu Multiflora</h5>
                  <div class="card-group">
                    <div class="card">
                      <div class="card-body">
                        <?php
                          $getmultiflora = mysqli_query ($koneksi,"SELECT * FROM multiflora ");
                          while ($data=mysqli_fetch_array($getmultiflora)) {
                          $idmultiflora = $data['id_multiflora'];
          ...
          <div class="card-deck text-dark text-center mt-2">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title"><?=$ukuran3;?> @ Rp <?=number_format($harga3);?></h5>
                <h5 class="card-title">
                  <?php
                  if($stock3 <=0)
                  {
                  ...
                  {
                    echo "Sisa Stock : $stock3";
                    echo "<div><a href='https://api.whatsapp.com/send?phone=6287780534000&text=Assalamuaikum,%20Saya%20mau%20pesan%20madunya%20gan/sis,%20dengan%20detail%20sebagai%20berikut%0ANama:%0AAlamat:%0AMadu: $namabarang%0AUkuran: $ukuran3%0AJumlah:%0ATerima Kasih' class='btn btn-success mt-2'>Pemesanan</a></div> ";
                  }
                  ?>
                  </h5>
              </div>
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title"><?=$ukuran4;?> @ Rp <?=number_format($harga4);?></h5>
                <h5 class="card-title">
                  <?php
                  if($stock4 <=0)
                  {
                  ...
                  {
                    echo "Sisa Stock : $stock4";
                    echo "<div><a href='https://api.whatsapp.com/send?phone=6287780534000&text=Assalamuaikum,%20Saya%20mau%20pesan%20madunya%20gan/sis,%20dengan%20detail%20sebagai%20berikut%0ANama:%0AAlamat:%0AMadu: $namabarang%0AUkuran: $ukuran4%0AJumlah:%0ATerima Kasih' class='btn btn-success mt-2'>Pemesanan</a></div> ";
                  }
                  ?>
                  </h5>
              </div>
