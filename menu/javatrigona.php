...
// 350 Gram
$getjumlah = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '17'");
...
// 500 Gram
$getjumlah1 = mysqli_query($koneksi,"SELECT * FROM stock WHERE id_stock = '18'");
  ...
  <body>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item  active" href="#">Javatrigona</a>
            </div>
          </li>
          <li class="nav-item">
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
          <h1 class="text-center text-warning">Madu Javatrigona</h1>
          <h5 class="border-bottom">Java Hills Madu rasa <i>Javatrigona</i> merupakan madu unik dan langka dari lebah kecil yang tidak menyengat. Mereka hanya memproduksi madu dalam jumlah terbatas tetapi hasil akhirnya adalah madu obat yang cocok untuk apitherapy.</h5>
          <div class="card-deck">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title text-dark border-bottom text-center">Manfaat Madu Javatrigona</h5>
                  <div class="card-group">
                    <div class="card">
                      <div class="card-body">
                        <?php
                          $getjavatrigona = mysqli_query ($koneksi,"SELECT * FROM javatrigona ");
                          while ($data=mysqli_fetch_array($getjavatrigona)) {
                          $idjavatrigona = $data['id_javatrigona'];
                    ...
                    <div class="card">
                      <div class="card-body">
                        <p class="card-text text-dark">keistimewaan madu javatrigona</p>
                        <?php
                          $getjavatrigona = mysqli_query ($koneksi,"SELECT * FROM javatrigona ");
                          while ($data=mysqli_fetch_array($getjavatrigona)) {
                          $idjavatrigona = $data['id_javatrigona'];
