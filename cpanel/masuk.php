            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 style="font-family: times new roman;">Barang Masuk</h1>
                        ...
                        <div>
                            <div>
                                <table class="table table-bordered">
                                    ...
                                    <?php
                                    $no=1;
                                    $tampil = mysqli_query ($koneksi,"SELECT * FROM masuk m, supplier s WHERE m.id_supplier=s.id_supplier ");
                                    while ($data= mysqli_fetch_array($tampil)) {
                                        ...
                                        // cari subtotal invoice
                                        $getsubtotal = mysqli_query($koneksi," SELECT SUM(subtotal_masuk) AS hasil FROM detailmasuk WHERE id_masuk='$data[id_masuk]'");
                                        $subtotal = mysqli_fetch_array($getsubtotal);
                                        $total = $subtotal['hasil'];

                                        // cari ongkir masuk
                                        $getongkirmasuk = mysqli_query($koneksi, " SELECT * FROM ongkir_masuk WHERE id_masuk = '$data[id_masuk]'");
                                        $hasilongkrimasuk = mysqli_fetch_array($getongkirmasuk);
                                        $ongkirmasuk = isset($hasilongkrimasuk['ongkos_masuk'])?$hasilongkrimasuk['ongkos_masuk'] : '0';

                                        // Total ongkir
                                        $akhir = $total+$ongkirmasuk;
                                    ?>
                                    <tbody>
                                        <tr>
                                            <td><?=$no++;?></td>
                                            ...
                                            <td>
                                                <a href="detail_barang_masuk.php?idm=<?=$idmasuk;?>" class="btn btn-warning">Detail</a>
                                            ...
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-header">
                                                  <h4 class="modal-title">Hapus Barang <?=$namasupplier;?></h4>
                                                ...
                                                <div class="modal-body">
                                                    Apakah Anda Yakin Akan Hapus Barang Ini ?
                                                    <input type="hidden" name="idmasuk" class="form-control mt-2"  value="<?=$idmasuk;?>">
                                                </div>
      ...
      <div class="modal fade" id="myModal">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <select class="form-control mt-2" name="idsupplier">
                    <option value="Pilih Supplier">Pilih Supplier</option>
                    <?php
                    $getsupplier = mysqli_query($koneksi, "SELECT * FROM supplier ");
