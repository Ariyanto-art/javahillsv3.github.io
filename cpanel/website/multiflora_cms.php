                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link active" href="#">Multiflora</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 style="font-family: times new roman;">Multiflora</h1>
                        ...
                        <div>
                            <div>
                                <table class="table table-bordered">
                                    ...
                                    <?php
                                    $no=1;
                                    $tampil = mysqli_query ($koneksi,"SELECT * FROM multiflora ");
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?=$manfaatkanan;?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?=$idmultiflora;?>">
                                                    Edit
                                                </button>
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idmultiflora;?>">
                                                    Hapus
                                                </button>
                                            </td>
                                        </tr>
                                        <!-- The Modal Edit -->
                                          <div class="modal fade" id="edit<?=$idmultiflora;?>">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="idmultiflora" value="<?=$idmultiflora;?>">
                                                </div>
                                                
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-success" name="editmultiflora">Submit</button>
                                          ...
                                          <!-- The Modal Delete -->
                                          <div class="modal fade" id="delete<?=$idmultiflora;?>">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-success" name="deletemultiflora">Submit</button>
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                </div>
      ...
      <div class="modal fade" id="myModal">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="submit" class="btn btn-success" name="multiflora">Submit</button>
                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
            </div>
