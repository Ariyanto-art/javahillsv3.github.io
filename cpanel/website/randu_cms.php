                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link  active" href="ra#">Randu Blossom</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 style="font-family: times new roman;">Randu Blossom</h1>
                        ...
                        <div>
                            <div>
                                <table class="table table-bordered">
                                    ...
                                    <?php
                                    $no=1;
                                    $tampil = mysqli_query ($koneksi,"SELECT * FROM randu ");
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?=$manfaatkanan;?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?=$idrandu;?>">
                                                    Edit
                                                </button>
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idrandu;?>">
                                                    Hapus
                                                </button>
                                            </td>
                                        </tr>
                                        <!-- The Modal Edit -->
                                          <div class="modal fade" id="edit<?=$idrandu;?>">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="idrandu" value="<?=$idrandu;?>">
                                                </div>
                                                
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-success" name="editrandu">Submit</button>
                                          ...
                                          <!-- The Modal Delete -->
                                          <div class="modal fade" id="delete<?=$idrandu;?>">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-success" name="deleterandu">Submit</button>
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                </div>
      ...
      <div class="modal fade" id="myModal">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="submit" class="btn btn-success" name="randu">Submit</button>
                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
            </div>
