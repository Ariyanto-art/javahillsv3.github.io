            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 style="font-family: times new roman;">Daftar Supplier</h1>
                                            ...
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-header">
                                                  <h4 class="modal-title">Ubah Data <?=$namasupplier;?></h4>
                                                ...
                                                <div class="modal-body">
                                                    <input type="text" name="name_supplier" class="form-control" placeholder="Input Nama" value="<?=$namasupplier;?>">
                                                    <textarea type="text" name="alamat_supplier" class="form-control mt-2" placeholder="Jl.xyz123" value="<?=$alamat;?>"><?=$alamat;?></textarea>
                                                    <input type="text" name="telp_supplier" class="form-control mt-2" placeholder="Input Nomor Telepon" value="<?=$notelp;?>">
                                                    <input type="hidden" name="ids" value="<?=$idsupplier;?>">
                                                </div>
      ...
      <div class="modal fade" id="myModal">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <input type="text" name="name_supplier" class="form-control" placeholder="Input Nama">
                <textarea type="text" name="alamat_supplier" class="form-control mt-2" placeholder="Jl.xyz123"></textarea>
                <input type="text" name="telp_supplier" class="form-control mt-2" placeholder="Input Nomor Telepon">
            </div>
            
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="submit" class="btn btn-success" name="supplier">Submit</button>
                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
            </div>
